...
It is uncommon for there to be CPM values greater than 50 or less than 0.001, but it is not implausible. What had been done prior to this section include removing irretrievable data values (-999). We can validate reverse negation using histograms representing the distribution of newly modified PRICE_clean.
