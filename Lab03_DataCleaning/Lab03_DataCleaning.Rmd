...
| **DEVICE_GEO_ZIP**  | Sentinel codes (-999), non-digit chars, wrong length  | Validity / Accuracy        | Ssentinels to 'NA'; Trim to 5 digits; Keep valid Oregon ZIPs (97xxx) |
...
**Esther:**
  ...
  - The most time-consuming data cleaning task by far was converting everyone's work into one cohesive flow which did not override others' previous work and ensuring a logical flow with justifications of actions & decisions.
  - These all proved to be useful at various points in the cleanup.
  - I would definitely find a way to have the team work sequentially with shorter deadlines for each section. This process of splitting the work and one person compiling into a single documents proved much more work than expected and more work than a single person doing the entire lab by themselves. As far as a general messy dataset, a strong initial plan of action along with sequential, organized workflow with full justifications of each decision is imperative.
  - I attempted to use generative AI to help streamline the consolidation process and check for any code chunks which override the work of previous teammates' code chunks. However, I immediately saw issues and could not trust this would not introduce more errors. It proved to be more work than just working through the document myself, as I would still to perform these checks myself anyway to ensure the AI had not misled me.
